<x-main-layout>
    ...
    <section class="pb-10 lg:pb-24 lg:pt-14">
        <div class="container mx-auto px-5">
            ...
            <div class="mt-8 bg-navy dark:bg-navy/80 py-14 px-6 rounded-3xl">
    ...
    <section class="pb-10 lg:pb-24">
        <div class="container mx-auto px-5">
            <div class="text-center pb-14">
                <h1 class="title uppercase max-w-3xl mx-auto">VISI</h1>
                <p
                    class="md:text-lg lg:text-xl font-plusjakartasans text-zinc-700 dark:text-zinc-300 font-medium mt-10 max-w-4xl mx-auto">
            ...
            <div class="text-center pt-12">
                <h1 class="title uppercase max-w-3xl mx-auto">misi</h1>
                <div class="flex flex-wrap -mx-4 mt-14">
                    <div class="w-full lg:w-1/3 px-4 mb-4 lg:mb-0">
                        <div
                            class="bg-[#486DA3]/15 h-full rounded-3xl hover:bg-navy2 duration-500 dark:bg-transparent dark:bg-gradient-to-br dark:from-zinc-800/80 dark:to-zinc-900 py-10 px-8 group">
                            <div class="flex items-center justify-between gap-4">
                                <div
                                    class="w-14 h-14 flex items-center justify-center group-hover:bg-navylight dark:group-hover:bg-navy duration-300 rounded-full bg-[#395682] text-3xl font-plusjakartasans font-extrabold text-white">
                                    1
                                </div>
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        stroke-width="1.5" stroke="currentColor"
                                        class="w-12 h-12 text-navy dark:text-zinc-500 group-hover:text-white duration-300">
                            ...
                            <p
                                class="text-left text-xl md:text-2xl mt-8 text-navy font-medium dark:text-zinc-300 group-hover:text-white duration-300">
                                Menciptakan iklim organisasi yang dinamis dan progresif
                            </p>
                        </div>
                    </div>
                    <div class="w-full lg:w-1/3 px-4 mb-4 lg:mb-0">
                        <div
                            ...
                            <p
                                class="text-left text-xl md:text-2xl mt-8 text-navy font-medium dark:text-zinc-300 group-hover:text-white duration-300">
                                Mengoptimalkan kepengurusan hmtif sebagai wadah terjalinnya komunikasi yang produktif
                                dalam ruang lingkup internal HMTIF maupun dengan pihak eksternal
                            </p>
                        </div>
                    </div>
                    <div class="w-full lg:w-1/3 px-4 mb-4 lg:mb-0">
                        <div
                            ...
                            <p
                                class="text-left text-xl md:text-2xl mt-8 text-navy font-medium dark:text-zinc-300 group-hover:text-white duration-300">
                                Membangkitkan kualitas pengurus HMTIF yang adaptif dan inovatif
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container mx-auto px-5">
            <div class="flex items-center justify-between flex-wrap gap-4">
                ...
                <div class=" mx-auto mt-3 lg:mt-0 lg:mx-0">
                    <img src="{{ asset('assets/img/logo.png') }}" class="w-40 lg:w-60 " alt="">
                </div>
            </div>
            <p class="mt-14 text-lg lg:text-2xl text-zinc-600 dark:text-zinc-300">

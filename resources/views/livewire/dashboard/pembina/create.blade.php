            ...
            <div class="bg-white border p-8 rounded-xl">
                <form wire:submit.prevent="create" class="space-y-6">
                    <div class="inline-flex items-center gap-3">
                        ...
                        @else
                            <div>
                                <img src="{{ asset('assets/img/no-photo.png') }}" alt=""
                                    class="w-24 h-24 rounded-full">
                            </div>
                        @endif
                        <div>
                    ...
                    <div>
                        <button class="btn-primary w-full flex items-center gap-2 justify-center {{ $croppedImage ? '' : 'cursor-not-allowed opacity-80' }}" type="submit" {{ $croppedImage ? '' : 'disabled' }}>
